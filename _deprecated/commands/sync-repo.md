...
3. Check if the repository already exists in the spec's `repo/` directory:
...
5. **Create a feature branch** in the cloned repository:
...
✓ Cloned my-org/my-project to specs/feature/123-add-auth/repo/my-project
  ...
  Tip: Read these files for project-specific guidance
