---
description: Create a new spec directory with the proper structure and templates
name: new-spec
argument-hint: type=[feature|bug|chore|design|planning] name=[spec-name] id=[ticket-id]
agent: agent
---
...
3. Confirm the spec has been created and provide the path to the user.
