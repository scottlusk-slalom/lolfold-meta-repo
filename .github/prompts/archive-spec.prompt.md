---
description: Archive a completed spec with proper memory promotion and cleanup
name: archive-spec
...
8. Provide archive confirmation:
   ...
   - Promoted 2 documents to project-level context
   - Deleted 3 scratch files
   - Removed cloned repositories

   The spec record is preserved with permanent context.
   ```
